...
const (
	...
	// SigningProposedTransferOnSolana is the step identifier for signing proposed transfer
	SigningProposedTransferOnSolana = "sign proposed transfer"
	...
	// PerformingTransfer is the step identifier for performing the transfer on Solana
	PerformingTransfer = "perform transfer"

	// WaitingTransferConfirmation is the step identifier for waiting the transfer confirmation on Solana
	...
	// NumSteps indicates how many steps the state machine for MultiversX -> Solana flow has
	NumSteps = 10
)
