...
const (
	// GettingPendingBatchFromSolana is the step identifier for fetching the pending batch from the Solana chain
	GettingPendingBatchFromSolana = "get pending batch from Solana"
	...
	// NumSteps indicates how many steps the state machine for Solana -> MultiversX flow has
	NumSteps = 5
)
