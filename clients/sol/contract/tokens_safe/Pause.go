...
func (inst *Pause) SetSafeSettingsAccount(safeSettings ag_solanago.PublicKey) *Pause {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(safeSettings).WRITE()
	return inst
}

// GetSafeSettingsAccount gets the "safeSettings" account.
func (inst *Pause) GetSafeSettingsAccount() *ag_solanago.AccountMeta {
...
func NewPauseInstruction(
	...
	safeSettings ag_solanago.PublicKey) *Pause {
