...
func (inst *RemoveRelayer) SetRelayer(relayer ag_solanago.PublicKey) *RemoveRelayer {
	inst.Relayer = &relayer
	return inst
}

// SetAdminAuthorityAccount sets the "adminAuthority" account.
func (inst *RemoveRelayer) SetAdminAuthorityAccount(adminAuthority ag_solanago.PublicKey) *RemoveRelayer {
...
func (inst *RemoveRelayer) GetAdminAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetBridgeSettingsAccount sets the "bridgeSettings" account.
func (inst *RemoveRelayer) SetBridgeSettingsAccount(bridgeSettings ag_solanago.PublicKey) *RemoveRelayer {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(bridgeSettings).WRITE()
	return inst
}

// GetBridgeSettingsAccount gets the "bridgeSettings" account.
func (inst *RemoveRelayer) GetBridgeSettingsAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetRelayerSettingsAccount sets the "relayerSettings" account.
func (inst *RemoveRelayer) SetRelayerSettingsAccount(relayerSettings ag_solanago.PublicKey) *RemoveRelayer {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(relayerSettings).WRITE()
	return inst
}

// GetRelayerSettingsAccount gets the "relayerSettings" account.
func (inst *RemoveRelayer) GetRelayerSettingsAccount() *ag_solanago.AccountMeta {
