...
func (inst *Unpause) SetBridgeSettingsAccount(bridgeSettings ag_solanago.PublicKey) *Unpause {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(bridgeSettings).WRITE()
	return inst
}

// GetBridgeSettingsAccount gets the "bridgeSettings" account.
func (inst *Unpause) GetBridgeSettingsAccount() *ag_solanago.AccountMeta {
...
func NewUnpauseInstruction(
	...
	bridgeSettings ag_solanago.PublicKey) *Unpause {
